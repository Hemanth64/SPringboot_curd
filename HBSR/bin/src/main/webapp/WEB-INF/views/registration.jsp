								...
								<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
									...
									<div class="form-group row">
										...
										<label class="col-sm-12 col-md-1 col-form-label"></label> <label
											...
											color="blue"> Registration Form to be Completed by
												Potential Participating Centres / Individuals </font>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6 col-md-4">
											<input class="form-control" type="text" placeholder=""
												id="mobile1" name="mobile1" maxlength="15"
												/>
										</div>
										<label class="col-sm-12 col-md-2 col-form-label">
											Email-ID </label>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6 col-md-4">
											<input class="form-control" type="text" placeholder=""
												maxlength="15" id="mobile2" name="mobile2"
												  />
										</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6 col-md-4">
											<input class="form-control" type="text" placeholder=""
												maxlength="50" id="name2" name="name2" />
										</div>
										<label class="col-sm-12 col-md-2 col-form-label">
											Designation </label>
										<div class="col-sm-12 col-md-4">
											<input class="form-control" type="text" placeholder=""
												maxlength="150" id="desi2" name="desi2" />
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-6 col-md-4">
											<input class="form-control" type="text" placeholder=""
												id="mobile3" name="mobile3" maxlength="15"
													/>
										</div>
										<label class="col-sm-12 col-md-2 col-form-label">
											Email-ID </label>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6 col-md-4">
											<input class="form-control" type="text" placeholder=""
												maxlength="50" id="name3" name="name3" />
										</div>
										<label class="col-sm-12 col-md-2 col-form-label">
											Designation </label>
										<div class="col-sm-12 col-md-4">
											<input class="form-control" type="text" placeholder=""
												id="desi3" name="desi3" maxlength="150" />
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-6 col-md-4">
											<input class="form-control" type="text" placeholder=""
												id="mobile4" name="mobile4" maxlength="15"
												 />
										</div>
										<label class="col-sm-12 col-md-2 col-form-label">
											Email-ID </label>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6 col-md-4">
											<input class="form-control" type="text" placeholder=""
												id="name4" name="name4" maxlength="50" />
										</div>
										<label class="col-sm-12 col-md-2 col-form-label">
											Designation </label>
										<div class="col-sm-12 col-md-4">
											<input class="form-control" type="text" placeholder=""
												id="desi4" name="desi4" maxlength="150" />
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-6 col-md-4">
											<input class="form-control" type="text" placeholder=""
												id="mobile5" name="mobile5" maxlength="15"
												 />
										</div>
										<label class="col-sm-12 col-md-2 col-form-label">
											Email-ID </label>
									...
									<div class="form-group row">
										...
										<div class="col-sm-12 col-md-6">
											<input class="form-control" type="text" name="brefily"
												maxlength="250" id="briefly" disabled />
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-12 col-md-6 col-form-label">
												...
												<div class="custom-control custom-radio mb-5">
													<div class="custom-control custom-checkbox mb-5">
														<input type="checkbox" class="custom-control-input"
															id="customCheck1" name="obtainInfo"
													...
													<div class="custom-control custom-checkbox mb-">
														<input type="checkbox" class="custom-control-input"
															name="obtainInfo" id="customCheck2"
													...
													<div class="custom-control custom-checkbox mb-5">
														<input type="checkbox" class="custom-control-input"
															name="obtainInfo" id="customCheck3"
													...
													<div class="custom-control custom-checkbox mb-5">
														<input type="checkbox" class="custom-control-input"
															name="obtainInfo" id="customCheck4"
													...
													<div class="custom-control custom-checkbox mb-5">
														<input type="checkbox" class="custom-control-input"
															name="obtainInfo" id="customCheck6"
													...
													<div class="custom-control custom-checkbox mb-5">
														<input type="checkbox" class="custom-control-input"
															id="customCheck7" name="obtainInfo" value="Specify:">
														<label class="custom-control-label" for="customCheck7">
															Other means (Please specify the methodologies) </label>
														<div class="col-sm-12 col-md-6">
															<input class="form-control" type="text"
																placeholder="specify" id="specify2" name="obtainInfo"
													...
													<div class="custom-control custom-radio  mb-5">
														<div class="custom-control custom-checkbox mb-5">
															<input type="checkbox" id="customCheck8"
																name="mainOfMedRec" value="Only In-Patient Records"
														...
														<div class="custom-control custom-checkbox mb-5">
															<input type="checkbox" id="customCheck10"
																name="mainOfMedRec" value="No Medical Records"
																class="custom-control-input"> <label
														...
														<div class="col-md-12 col-sm-12">
															...
															<div class="custom-control custom-checkbox mb-5">
																<input type="checkbox" id="checkbox11"
																	name="internetconn" value="a) Broad Band-Overall"
																	class="custom-control-input"> <label
															...
															<div class="custom-control custom-checkbox mb-5">
																<input type="checkbox" id="checkbox13"
																	name="internetconn" class="custom-control-input">
																<label class="custom-control-label" for="checkbox13">
																	c) Others </label>
																<div class="col-sm-2 col-md-8">
																	<input class="form-control" type="text"
																		placeholder="specify" id="specify3"
																		name="internetconn" maxlength="250" disabled>
																</div>
															</div>
														</div>
													</div>
