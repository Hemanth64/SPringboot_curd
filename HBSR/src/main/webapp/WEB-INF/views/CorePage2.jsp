...
$(function() {
	...
	if ($("#patlastseentime").val() != "") {
		...
		$("#TimeMn").val($.trim(str.substring(5,8)));
		$("#TimeAmPm option[value='" + str.substring(9, 12) + "']").prop(
				'selected', true);
	}
});
$(function() {
	...
	if ($("#onsetstroketime").val() != "") {
		...
		$("#TimeMn1").val($.trim(str.substring(5,8)));
		$("#TimeAmPm1 option[value='" + str.substring(9, 12) + "']").prop(
				'selected', true);
	}
});
...
$(function() {
	...
	if ($("#firstStrsymptime").val() != "") {
		...
		$("#TimeMn2").val($.trim(str.substring(5,8)));
		$("#TimeAmPm2 option[value='" + str.substring(9, 12) + "']").prop(
				'selected', true);
	}
});
$(function() {
	...
	if ($("#aarivaltime").val() != "") {
		...
		$("#TimeMn3").val($.trim(str.substring(5,8)));
		$("#TimeAmPm3 option[value='" + str.substring(9, 12) + "']").prop(
				'selected', true);
	}
});
...
$(function() {
	...
	if ($("#historyTIAtime").val() != "") {
		...
		$("#TimeMn4").val($.trim(str.substring(5,8)));
		$("#TimeAmPm4 option[value='" + str.substring(9, 12) + "']").prop(
				'selected', true);
	}
});
</script>
...
<body>
		...
		<div class="row">
			...
			<div class="col-md-2">
				...
				<div class="custom-control custom-checkbox mb-5">
					<form:checkbox class="custom-control-input cul_grp" path="cultural"
	...
	<div class="form-group">
		<div class="row">
			...
			<div class="col-md-2">
				...
				<div class="custom-control custom-checkbox mb-5">
					<form:checkbox class="custom-control-input cul_grp" path="culturalOthers"
	...
	<div class="form-group row">
		...
		<div class=" col-md-2">
			<form:input type="text" class="form-control date-picker dat"
				id="lsdate" tabindex="145" placeholder="Select Date"
				path="patlastseendate" value="${CoreObject.patlastseendate}" />
		</div>
		<div class=" col-md-1">
		...
		<div class="col-md-3">
			...
			<div class="row">
				<div class="col-md-2 text-center"
					...
					<input class="form-control valKeyN time tim_hr" type="text" id="Timehr"
						name="deathTime" value="" maxlength="2" tabindex="146" />
				</div>
				...
				<div class="col-md-2 text-center"
					style="padding: 0.10px; margin: 0px; width: 30px;">
					<input class="form-control valKeyN tim_mn" type="text" id="TimeMn"
						name="deathTimeMn" value="" maxlength="2" tabindex="147" />
				</div>
				<div class="col-xd-1" style="width: 10px;"></div>
				<div class="col-md-4 text-center"
					style="padding: 1px; margin: 0px; width: 80px;">
					<select class="form-control" id="TimeAmPm" name="deathTimeAmPm" tabindex="148"> 
		...
		<form:input type="hidden" id="patlastseentime" path="patlastseentime" tabindex="149"
	...
	<div class="form-group row">
		...
		<label class="col-md-5 col-form-label"><code
			...
			of this episodes of stroke </label>
		<div class="form-group">
		...
		<div class="col-sm-12 col-md-2">
			<form:input type="text" class="form-control date-picker dat"
				id="ondate" tabindex="150" path="onsetstrokedate"
				placeholder="Select Date" value="${CoreObject.onsetstrokedate}" />
		</div>
		...
		<div class=" col-md-3">
			...
			<div class="row">
				<div class="col-md-2 text-center"
					style="padding: 0.10px; margin: 0px; width: 30px;">
					<input class="form-control valKeyN time tim_hr" type="text" id="Timehr1"
						name="deathTime" value="" maxlength="2" tabindex="151"/>
				</div>
				<div class="col-md-1 text-center"
					style="padding-top: 5px; padding-left: 0px; padding-right: 0px; width: 5px;">
					<strong>:</strong>
				...
				<div class="col-md-2 text-center"
					style="padding: 0.10px; margin: 0px; width: 30px;">
					<input class="form-control valKeyN tim_mn" type="text" id="TimeMn1" tabindex="152"
						name="deathTimeMn" value="" maxlength="2" />
				</div>
				<div class="col-xd-1" style="width: 10px;"></div>
				<div class="col-md-4 text-center"
					style="padding: 1px; margin: 0px; width: 80px;">
					<select class="form-control" id="TimeAmPm1" name="deathTimeAmPm" tabindex="153">
		...
		<form:input type="hidden" id="onsetstroketime" path="onsetstroketime" tabindex="154"
		...
		<div class="row">
			...
			<div class="col-md-8">
				<label><code style="padding-right: 10px; color: black">11.3</code>Is
					it a wake-up stroke? <span class="italic"><font size="2">(symptoms of stroke first noticed on waking up from sleep)
							 </font></span></label>
			</div>
			...
			<div class="col-md-2">
				...
				<div class="custom-control custom-radio mb-3">
					<form:radiobutton id="customRadio8" value="1" tabindex="155"
			...
			<div class="col-md-2">
				...
				<div class="custom-control custom-radio mb-3">
					<form:radiobutton id="customRadio9" value="2" tabindex="156"
						class="custom-control-input" path="wakeupStroke"
	...
	<div class="form-group">
		<div class="row">
			...
			<div class="col-md-12">
				<label id="sympt_onsetErr" class="errorMsg">Please choose at
					least one checkbox *</label>
			</div>
		</div>
	</div>
	<div class="form-group">
			...
			<div class="col-md-3">
				...
				<div class="custom-control custom-checkbox mb-5">
					<form:checkbox class="custom-control-input sympt_onset" value="1"
						tabindex="157" path="sympWeek" id="customCheck1-113"
						checked="${CoreObject.sympWeek == '1' ? 'checked' : '' }" />
					<label class="custom-control-label" for="customCheck1-113">Weakness/paresis of limbs
					</label>
				</div>
			</div>
			<div class="col-md-4">
				...
				<div class="custom-control custom-checkbox mb-5">
					<form:checkbox class="custom-control-input sympt_onset" value="2"
						tabindex="158" path="sympDysp" id="customCheck1-114"
			...
			<div class="col-md-4">
				<div class="custom-control custom-checkbox mb-5">
					<form:checkbox class="custom-control-input sympt_onset" value="3"
						tabindex="159" path="sympAltered" id="customCheck1-115"
		...
		<div class="row">
			...
			<div class="col-md-2">
				...
				<div class="custom-control custom-checkbox mb-5">
					<form:checkbox class="custom-control-input sympt_onset"
						path="sympAltered" value="" tabindex="160" id="customCheck1-116"
						onClick="enable2()" />
			...
			<div class="col-md-4">
				...
				<div class="custom-control">
					<form:input class="form-control valKeyCN" type="text" id="sympt"
						tabindex="161" path="sympOnsetOthers" maxlength="250"
	...
	<div class=" row">
		...
		<div class=" col-md-3">
			<div class="row form-group">			
					<label class=" col-md-4 col-form-label" for="firstStrsympdate">
					Date </label>
					<div class=" col-md-8">
						<form:input class="form-control date-picker dat" type="text"
							id="symdate" tabindex="162" path="firstStrsympdate"
		...
		<div class=" col-md-4">
			...
			<div class="row">
					<label class=" col-md-2 col-form-label" for="firstStrsymptime">Time
					</label>
				<div class="col-md-2 text-center"
					style="padding: 0.10px; margin: 0px; width: 30px;">
					<input class="form-control valKeyN time tim_hr" type="text" id="Timehr2" tabindex="163"
				...
				<div class="col-md-2 text-center"
					style="padding: 0.10px; margin: 0px; width: 30px;">
					<input class="form-control valKeyN tim_mn" type="text" id="TimeMn2" tabindex="164"
						name="deathTimeMn" value="" maxlength="2" />
				</div>
				<div class="col-xd-1" style="width: 10px;"></div>
				<div class="col-md-4 text-center"
					style="padding: 1px; margin: 0px; width: 80px;">
					<select class="form-control" id="TimeAmPm2" name="deathTimeAmPm" tabindex="165">
...
<form:input type="hidden" id="firstStrsymptime"
			path="firstStrsymptime" value="${CoreObject.firstStrsymptime}" tabindex="166"/>
		</div>
	...
	<div class="form-group">
		<div class="row">
			...
			<div class="col-md-2">
				...
				<div class="custom-control custom-checkbox mb-5">
					<form:checkbox id="customRadio384" value="1" tabindex="167"
						class="custom-control-input treatStrk" path="tStroke_Home"
						onClick="enable3()"
			...
			<div class="col-md-6">
				...
				<div class="custom-control custom-checkbox mb-5">
					<form:checkbox id="customRadio385" value="4" tabindex="168"
						class="custom-control-input treatStrk" path="treatStrk_OthDeptRptHsp"
						onClick="enable3()"
	...
	<div class="form-group">
		<div class="row">
			...
			<div class="col-md-4">
				...
				<div class="custom-control custom-checkbox mb-5">
					<form:checkbox id="customRadio386" value="3" tabindex="169"
						class="custom-control-input treatStrk" path="treatStrk_OthPlcStrkonset"
						onClick="enable3()"
			...
			<div class="col-md-3">
				...
				<div class="custom-control custom-checkbox mb-5">
					<form:checkbox id="customRadio387" value="8" tabindex="170"
						class="custom-control-input treatStrk" path="treatStrk_OthSpy"
						onClick="enable3()"
			...
			<div class="col-md-3">
				<form:input class="form-control valKeyCN" type="text" id="treatment"
					tabindex="171" path="treatmentStrokeothers" maxlength="250"
	...
	<div class="form-group">
		<div class="row">
			...
			<div class="col-md-4">
				...
				<div class="custom-control custom-checkbox mb-5">
					<form:checkbox id="customRadio388" value="2" tabindex="172"
						class="custom-control-input treatStrk" path="treatStrk_IpHelthcare"
						onClick="enable3()"
						checked="${CoreObject.treatmentStroke == '2' ? 'checked' : '' }" />
					<label class="custom-control-label" for="customRadio388"> <font>
							Outpatient healthcare setting </font>
					</label>
			...
			<div class="col-md-4">
				...
				<div class="custom-control custom-checkbox mb-5">
					<form:checkbox id="customRadio389" value="9" tabindex="173"
						class="custom-control-input" path="treatStrk_Unknown"
						onClick="enable3()"
	...
	<div class="form-group">
		<div class="row">
			...
			<div class="col-md-11">
				...
				<div class="custom-control custom-checkbox mb-5">
					<form:checkbox id="customRadio340" value="3"
						class="custom-control-input treatStrk" path="treatStrk_IpHelthcare" tabindex="174"
						onClick="enable3()"
						checked="${CoreObject.treatmentStroke == '3' ? 'checked' : '' }" />
					<label class="custom-control-label" for="customRadio340"> <font>
							Inpatient healthcare setting </font>
					</label>
	...
	<div class="form-group row">
		...
		<div class=" col-md-2">
			<form:input class="form-control date-picker dat" type="text"
				id="arivdate" tabindex="175" path="aarivaldate"
				value="${CoreObject.aarivaldate}" />
		</div>
		...
		<div class=" col-md-3">
			...
			<div class="row">
				<div class="col-md-2 text-center"
					style="padding: 0.10px; margin: 0px; width: 30px;">
					<input class="form-control valKeyN time tim_hr" type="text" id="Timehr3"
						name="deathTime" value="" maxlength="2" tabindex="176"/>
				</div>
				<div class="col-md-1 text-center"
					style="padding-top: 5px; padding-left: 0px; padding-right: 0px; width: 5px;">
					<strong>:</strong>
				...
				<div class="col-md-2 text-center"
					style="padding: 0.10px; margin: 0px; width: 30px;">
					<input class="form-control valKeyN tim_mn" type="text" id="TimeMn3" tabindex="177"
						name="deathTimeMn" value="" maxlength="2" />
				</div>
				<div class="col-xd-1" style="width: 10px;"></div>
				<div class="col-md-4 text-center"
					style="padding: 1px; margin: 0px; width: 80px;">
					<select class="form-control" id="TimeAmPm3" name="deathTimeAmPm" tabindex="178">
		...
		<form:input type="hidden" id="aarivaltime" path="aarivaltime" tabindex="179"
	...
	<div class="form-group row">
		...
		<div class=" col-md-2">
			<form:input type="text" class="form-control date-picker dat"
				id="digdate" tabindex="180" path="diagOfStroke"
				placeholder="Select Date" value="${CoreObject.diagOfStroke}" />
		</div>
	...
	<div class="form-group row">
		...
		<div class="col-md-1">
			...
			<div class="custom-control custom-radio mb-3">
				<form:radiobutton id="customRadio10" value="1" tabindex="181"
		...
		<div class="col-md-1">
			<div class="custom-control custom-radio mb-3">
				<form:radiobutton id="customRadio11" value="2" tabindex="182"
					class="custom-control-input" path="historyTIA"
					onClick="showHideInfo3()"
		...
		<div class=" col-md-2">
			<form:input type="text" class="form-control date-picker dat tiadate"
				tabindex="183" path="historyTIAdate" id="tiadate" disabled="true"
				value="${CoreObject.historyTIAdate}" />
		</div>
	...
	<div class="form-group row">
		...
		<label class="col-md-12 col-form-label"><code
			...
			Findings at Reporting Institution </label>

	</div>
	<div class="form-group">
		<div class="row">
			<div class="col-md-4">
				<label id="clin_Err" class="errorMsg">Please choose at least
					one *</label>
			</div>
		</div>
	</div>
	...
	<div class="form-group">
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="custom-control custom-checkbox mb-5">
					<form:checkbox class="custom-control-input clinc_finding cl_fin"
						tabindex="188" path="clinRIUnilateral" value="a"
						id="customCheck1-127"
			...
			<div class="col-md-5">
				...
				<div class="custom-control custom-checkbox mb-5">
					<form:checkbox class="custom-control-input clinc_finding cl_fin"
						tabindex="189" path="clinRISensory" value="b"
						id="customCheck1-128"
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="custom-control custom-checkbox mb-5">
					<form:checkbox class="custom-control-input clinc_finding cl_fin"
						tabindex="190" path="clinRIAphasia" value="c"
						id="customCheck1-129"
			...
			<div class="col-md-5">
				...
				<div class="custom-control custom-checkbox mb-5">
					<form:checkbox class="custom-control-input clinc_finding cl_fin"
						tabindex="191" path="clinRIHeminophia" value="d"
						id="customCheck1-130"
						checked="${CoreObject.clinRIHeminophia == 'd' ? 'checked' : '' }" />
					<label class="custom-control-label" for="customCheck1-130">
						Hemianopia<span class="italic size="2">(half-sided
							impairment  of visual fields)</span>
					</label>
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="custom-control custom-checkbox mb-5">
					<form:checkbox class="custom-control-input clinc_finding cl_fin"
						tabindex="192" path="clinRIGaze" value="e" id="customCheck1-131"
			...
			<div class="col-md-5">
				...
				<div class="custom-control custom-checkbox mb-5">
					<form:checkbox class="custom-control-input clinc_finding cl_fin"
						tabindex="193" path="clinRIApraxia" value="f"
						id="customCheck1-132"
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="custom-control custom-checkbox mb-5">
					<form:checkbox class="custom-control-input clinc_finding cl_fin"
						tabindex="194" path="clinRIAtaxia" value="g" id="customCheck1-134"
			...
			<div class="col-md-5">
				...
				<div class="custom-control custom-checkbox mb-5">
					<form:checkbox class="custom-control-input clinc_finding cl_fin"
						tabindex="195" path="clinRINeglect" value="h"
						id="customCheck1-135" 
		...
		<div class="row">
			...
			<div class="col-md-11">
				...
				<div class="custom-control custom-checkbox mb-5">
					<form:checkbox class="custom-control-input clinc_finding"
						tabindex="196" path="clinRINone" value="i" id="customCheck1-136" 
